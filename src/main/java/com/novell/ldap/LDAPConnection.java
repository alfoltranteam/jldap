...
public class LDAPConnection implements Cloneable
{
     ...
     * by the object.
     *
     * @exception com.novell.ldap.LDAPException A general exception which includes an error
     ...
     *
     * @see #bind( String, String, String[], java.util.Map, Object )
     */
     ...
     * connection.</p>
     *
     * @exception com.novell.ldap.LDAPException Thrown if TLS cannot be started.  If a
     ...
     *
     * @throws com.novell.ldap.LDAPException This can occur for the following reasons: <UL>
     ...
     *
     * <p>If the request fails with {@link com.novell.ldap.LDAPException#CONNECT_ERROR},
     ...
     * If the request fails with {@link com.novell.ldap.LDAPException#CONNECT_ERROR},
     ...
     *  @param cons    The constraints specific to the operation.
     *
     * @exception com.novell.ldap.LDAPException A general exception which includes an
     ...
     *
     *  @exception com.novell.ldap.LDAPException if the object was not found
     */
     ...
     * request object is a subclass {@link com.novell.ldap.LDAPMessage} with the operation
     ...
     * @see com.novell.ldap.LDAPMessage#isRequest()
     */
     ...
     * {@link com.novell.ldap.LDAPMessage} with the operation type set to one of the request
   ...
   void releaseReferralConnections( ArrayList list)
   {
     ...
     * will be empty.
     *
     * @exception com.novell.ldap.LDAPException     This exception occurs if the schema entry
     ...
     *              Directory.
     *  @exception com.novell.ldap.LDAPException     This exception occurs if the schema DN
     ...
     *
     * @exception com.novell.ldap.LDAPException     This exception occurs if a null or empty
