...
// ################### Methods to implement Set ##########################
    ...
    public boolean add(Object attr)
    {
        ...
        a = ((LDAPAttribute)attr).getWrappedObject();
     ...
     */
    private Collection unwrapCollection( Collection attrs)
    {
     ...
     */
    public boolean addAll(Collection attrs)
    {
    ...
    {
        com.novell.ldap.LDAPAttribute a;
        a = ((LDAPAttribute)obj).getWrappedObject();
