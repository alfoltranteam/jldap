...
public class GetReplicaInfoResponse extends LDAPExtendedResponse {
    ...
    *  &nbsp;&nbsp;&nbsp;&nbsp; flags &nbsp;&nbsp;&nbsp;              INTEGER</p>
    *
    * @exception java.io.IOException The response value could not be decoded.
    */
    ...
    *
    * @see com.novell.ldap.extensions.ReplicationConstants#LDAP_RS_BEGIN_ADD
    * @see com.novell.ldap.extensions.ReplicationConstants#LDAP_RS_DEAD_REPLICA
    * @see com.novell.ldap.extensions.ReplicationConstants#LDAP_RS_DYING_REPLICA
    * @see com.novell.ldap.extensions.ReplicationConstants#LDAP_RS_JS_0
    * @see com.novell.ldap.extensions.ReplicationConstants#LDAP_RS_JS_1
    * @see com.novell.ldap.extensions.ReplicationConstants#LDAP_RS_JS_2
    * @see com.novell.ldap.extensions.ReplicationConstants#LDAP_RS_LOCKED
    * @see com.novell.ldap.extensions.ReplicationConstants#LDAP_RS_MASTER_DONE
    * @see com.novell.ldap.extensions.ReplicationConstants#LDAP_RS_MASTER_START
    * @see com.novell.ldap.extensions.ReplicationConstants#LDAP_RS_SS_0
    * @see com.novell.ldap.extensions.ReplicationConstants#LDAP_RS_TRANSITION_ON
    */
    ...
    *
    * @see com.novell.ldap.extensions.ReplicationConstants#LDAP_RT_MASTER
    * @see com.novell.ldap.extensions.ReplicationConstants#LDAP_RT_SECONDARY
    * @see com.novell.ldap.extensions.ReplicationConstants#LDAP_RT_READONLY
    * @see com.novell.ldap.extensions.ReplicationConstants#LDAP_RT_SUBREF
    * @see com.novell.ldap.extensions.ReplicationConstants#LDAP_RT_SPARSE_WRITE
    * @see com.novell.ldap.extensions.ReplicationConstants#LDAP_RT_SPARSE_READ
    */
    ...
    *
    * @see com.novell.ldap.extensions.ReplicationConstants#LDAP_DS_FLAG_BUSY
    * @see com.novell.ldap.extensions.ReplicationConstants#LDAP_DS_FLAG_BOUNDARY
    */
   public int getflags() {
        return flags;
   }
