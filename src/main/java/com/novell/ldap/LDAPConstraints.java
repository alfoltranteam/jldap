 ...
 *
 * @see com.novell.ldap.LDAPConnection#setConstraints(com.novell.ldap.LDAPConstraints)
 */
public class LDAPConstraints implements Cloneable, java.io.Serializable {
     ...
     * @see com.novell.ldap.LDAPBindHandler
     * @see com.novell.ldap.LDAPAuthHandler
     ...
     *
     * @see #setControls(com.novell.ldap.LDAPControl)
     * @see #setControls(com.novell.ldap.LDAPControl[])
     */
