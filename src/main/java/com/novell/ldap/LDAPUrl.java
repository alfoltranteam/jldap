...
public class LDAPUrl implements Cloneable,Externalizable
{
    ...
    *
    * @exception java.net.MalformedURLException The specified URL cannot be parsed.
    */
    ...
    *
    *  @exception java.net.MalformedURLException The URL could not be parsed.
    */
    ...
    */
     ...
     *
     * @throws java.io.IOException if write fails on OutputStream
     */    
