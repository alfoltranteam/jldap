 ...
 *
 *  @see com.novell.ldap.LDAPConnection#LDAPConnection(com.novell.ldap.LDAPSocketFactory)
 *  @see com.novell.ldap.LDAPConnection#setSocketFactory
 */
public interface LDAPSocketFactory {
    ...
    *
    * @exception java.io.IOException The socket to the specified host and port
    *                        could not be created.
    *
    * @exception java.net.UnknownHostException The specified host could not be found.
    *
